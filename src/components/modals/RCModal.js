                ...
                footer={footer}>
                {
                    ...
                    <Form horizontal onSubmit={this.handleSubmit} >
                        ...
                        <FormItem
                            ...
                            labelCol={{span: 5}}
                            wrapperCol={{span: 15}}>
                            <RangePicker format="yyyy-MM-dd HH:mm"  value={[timeStampToStr(formData.Start,'y-m-d h:i:s'),timeStampToStr(formData.Start,'y-m-d h:i:s')]} disabled/>
                        </FormItem>
                        <Row>
                            <Col span="12">
                                <FormItem
                    ...
                    <Form horizontal onSubmit={this.handleSubmit} >
                        ...
                        <FormItem
                            ...
                            wrapperCol={{span: 15}}
                            required>
                            <RangePicker showTime  format="yyyy-MM-dd HH:mm" onChange={this.onDateChange}/>
                        </FormItem>
                        <Row>
                            <Col span="12">
                                <FormItem
