                    ...
                    footer={footer}>
                        {
                            ...
                            <Form horizontal onSubmit={this.handleSubmit} >
                                ...
                                <FormItem
                                    ...
                                    labelCol={{span: 6}}>
                                    <Col span="6">
                                        <DatePicker name="startDate" value={timeStampToStr(formData.overtime.Created,'y-m-d')}  disabled/>
                                    </Col>
                                    <Col span="1">
                                    <p className="ant-form-split">-</p>
                                    </Col>
                                    <Col span="6">
                                        <DatePicker name="endDate" value={timeStampToStr(formData.overtime.Ended,'y-m-d')} disabled/>
                                    </Col>
                                </FormItem>
...
export default Form.create({})(JBModal);